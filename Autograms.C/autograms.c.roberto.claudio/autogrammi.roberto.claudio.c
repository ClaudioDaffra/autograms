...
Found a sentence with 0 errors

[in this sentence there are] : three a's, one b, two c's, two d's, thirtyseven e's, five f's, 
one g, seven h's, nine i's, one j, one k, one l, twentyfour n's, fourteen o's, one p, one q, 
nine r's, ten s's, seventeen t's, three u's, six v's, five w's, two x's, three y's and one z.
...
int main() 
{
  char *input = "in this sentence there are";
  char *terminator = " and ";
  int findPangram = 0;
